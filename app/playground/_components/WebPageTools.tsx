...
import { Monitor, SquareArrowOutUpRight, Code2Icon } from "lucide-react";
...
<!DOCTYPE html>
        ...
        <meta name="description" content="AI Website Builder - Modern TailwindCSS + Flowbite Templates" />
  ...
  return (
    <div className="p-2 shadow rounded-xl w-full flex items-center justify-between">
      ...
      <div className="flex gap-2">
        ...
        <Button onClick={downloadCode}>Downlaoad <Download/> </Button>
